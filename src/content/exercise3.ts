export const evoyageFeatures = [
  'EV route planning across Vietnam',
  'Vehicle model and custom vehicle support',
  'Battery and range safety controls',
  'Charging stop recommendations',
  'Alternative charging stations',
